...
uicontrol('Style', 'togglebutton', 'String', 'Drone', ...
    'Position', [10 startY-gap*1 btnW btnH], 'Value', 1, ...
    'Callback', @(src,~) uav.togVis());

% Mapper elements, LSAM
uicontrol('Style', 'togglebutton', 'String', 'LSAM pts', ...
    'Position', [10 startY - gap*2 btnW btnH], 'Value', 1, ...
    'Callback', @(src,~) set(mapper.h_globalMapPlot, 'Visible', getVis(src)));

% uav lidar scan points
uicontrol('Style', 'togglebutton', 'String', 'Scan pts', ...
    'Position', [10 startY-gap*4 btnW btnH], 'Value', 1, ...
